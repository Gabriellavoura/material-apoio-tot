...
awslocal sqs send-message --queue-url http://localhost:4566/000000000000/InputQueue.fifo \
                          --message-group-id "test" \
                          --message-deduplication-id "test" \
                          --message-body '{"id": "12345", 
                                           "title":"LoremIpsum", 
                                           "author": "John Doe", 
                                           "year":"1960", 
                                           "genre":"Scifi", 
